...
var game = {
	...
	reset: function() {
		...
		maps.applyMap();
			...
			console.log("Error in maps module, 'applyMaps()'", err);
		}
	...
	start: function() {
		...
		html.addEventListener("keydown", game.keydownhandler, true);
		html.addEventListener("keyup", game.keyuphandler, true);
		html.addEventListener("keyhold", game.keyholdhandler, true);
	...
	updateArea: function() {
		for (t in game.player1.tanks) {
			...
			} else if (game.player1.customWinFunction(tank, t) || game.player2.customLoseFunction(game.player2.tanks[t], t)) {
		...
		for (t in game.player2.tanks) {
			...
			} else if (game.player2.customWinFunction(tank, t) || game.player1.customLoseFunction(game.player1.tanks[t], t)) {
				game.primaryTankDisabled = false;
